...
import { ArrowLeft, BarChart3, CheckCircle2, LoaderCircle, LockKeyhole, TriangleAlert } from 'lucide-react';
...
export default function BusinessQuestionnaireResults() {
  ...
  const resultsLocked = project?.questionnaire?.status !== 'PUBLISHED' || !responses.length;
