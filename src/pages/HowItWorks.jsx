...
export default function HowItWorks() {
  return (
    <main className="how-page">
      <style>{`
        .how-page { min-width: 320px; background: #050505; color: #edf4f2; font-family: var(--font-sans); }
        .how-shell { overflow: hidden; background: radial-gradient(circle at 78% 8%, rgba(62,94,90,.19), transparent 24%), linear-gradient(180deg, #050505 0%, #0a0b09 72%, #030303 100%); }
        ...
        .how-nav-links a { color: rgba(239,244,242,.62); font-size: 13px; font-weight: 780; text-decoration: none; }
        ...
        .how-kicker { margin: 0; color: #b6aa8c; font-size: 11px; font-weight: 900; letter-spacing: .18em; text-transform: uppercase; }
        ...
        .how-hero > p { max-width: 420px; margin: 0 0 5px; color: rgba(229,238,235,.66); font-size: 17px; line-height: 1.86; }
        .how-platform { border-top: 1px solid rgba(244,241,232,.15); padding: clamp(72px, 8vw, 120px) 0; }
        ...
        .how-platform-head > p, .how-panelist-head > p { max-width: 545px; margin: 8px 0 0; color: rgba(229,238,235,.66); font-size: 16px; line-height: 1.87; }
        .how-photo-grid { display: grid; grid-template-columns: 1.08fr .92fr; gap: 16px; margin-top: clamp(46px, 6vw, 82px); }
        .how-photo { position: relative; min-height: 350px; overflow: hidden; border-radius: 22px; background: #132328; }
        ...
        .how-photo:after { position: absolute; inset: 0; background: linear-gradient(180deg, transparent 42%, rgba(3,7,8,.84) 100%); content: ''; }
        ...
        .how-standards { background: #0b0e0e; border-top: 1px solid rgba(244,241,232,.12); border-bottom: 1px solid rgba(244,241,232,.12); padding: clamp(76px, 8vw, 124px) 0; }
        ...
        .how-standards-copy > p { max-width: 465px; color: rgba(229,238,235,.66); font-size: 16px; line-height: 1.85; }
        ...
        .how-standard-icon { display: grid; width: 40px; height: 40px; place-items: center; border: 1px solid rgba(244,241,232,.24); border-radius: 50%; color: #edf4f2; }
        .how-standard h3 { margin: 1px 0 0; color: #fff; font-size: 18px; }
        .how-standard p { max-width: 500px; margin: 8px 0 0; color: rgba(229,238,235,.63); font-size: 14px; line-height: 1.72; }
        .how-panelists { padding: clamp(76px, 9vw, 132px) 0; }
        ...
        .how-step { min-height: 220px; border: 1px solid rgba(244,241,232,.14); border-radius: 19px; background: linear-gradient(145deg, rgba(244,241,232,.055), rgba(255,255,255,.012)); padding: 25px; }
        .how-step > span { color: #b6aa8c; font-size: 12px; font-weight: 900; letter-spacing: .12em; }
        .how-step h3 { margin: 49px 0 0; color: #fff; font-size: 19px; }
        .how-step p { margin: 10px 0 0; color: rgba(229,238,235,.63); font-size: 14px; line-height: 1.72; }
        .how-reward { position: relative; min-height: 405px; overflow: hidden; border-radius: 24px; background: #0b1317; margin-top: 70px; }
        .how-reward img { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; opacity: .52; }
        .how-reward:after { position: absolute; inset: 0; background: linear-gradient(90deg, rgba(4,9,12,.92), rgba(4,9,12,.26)); content: ''; }
        ...
        .how-reward-copy > p { color: rgba(234,242,240,.69); font-size: 16px; line-height: 1.82; }
        ...
        .how-footer-row p { margin: 0; color: rgba(226,236,233,.48); font-size: 12px; }
        .how-footer-row a { color: rgba(235,242,239,.64); font-size: 12px; font-weight: 800; text-decoration: none; }
