...
const audienceModules = [
  ...
  { id: 'industry', title: 'Industry', detail: 'Useful for B2B and workforce studies. Edit the broad categories for the market you are studying.', type: 'SINGLE_CHOICE', prompt: 'Which industry do you mainly work in?', choices: ['Technology & telecommunications', 'Financial services', 'Consumer goods & retail', 'Healthcare & life sciences', 'Manufacturing & logistics', 'Professional services', 'Education', 'Public sector or nonprofit', 'Other', 'Prefer not to say'], settings: { allowOther: false } },
