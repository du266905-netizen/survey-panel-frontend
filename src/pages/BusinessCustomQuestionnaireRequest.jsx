  ...
  return <main className="business-custom-request-page">
    <div className="business-custom-request-shell">
      ...
      <section className="business-custom-request-surface">
        ...
        <footer className="business-custom-request-actions">{step === 2 && <button type="button" className="business-custom-request-quiet" onClick={() => { setError(''); setStep(1); }}>{copy.previous}</button>}{step === 1 ? <button type="button" className="business-button business-custom-request-next" onClick={goNext}>{copy.continue} <ArrowRight size={16} /></button> : <button className="business-button" type="submit" form="business-custom-questionnaire-form" disabled={submitting}>{submitting ? <LoaderCircle className="animate-spin" size={16} /> : copy.submit} {!submitting && <ArrowRight size={16} />}</button>}</footer>
      </section>
    </div>
