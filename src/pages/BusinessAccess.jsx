    ...
    <main className="business-access-page business-contact-page">
      ...
      {authMode ? (
        ...
        <div className="business-contact-layout">
          <section className="business-contact-intro"><p className="business-eyebrow">BUSINESS RESEARCH</p><h1>Turn your next question into useful evidence.</h1><p>Custom questionnaires, interviews, usability sessions, and focused studies for teams ready to learn from people.</p><Link to="/business/login" className="business-text-link">Already a client? Sign in <ArrowRight size={15} /></Link></section>
